/**
 * @package     WT Contact with fields
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    for (let i = 0, l = elements.length; l > i; i += 1) {
      ...
      elements[i].addEventListener('click', event => {
        ...
        const {
          editor
        } = Joomla.getOptions('xtd-wtcontactwithfieldsbutton');

        window.parent.Joomla.editors.instances[editor].replaceSelection("{wt_contact_wf contact_id=" + contact_id + " tmpl=" + tmpl + "}");
